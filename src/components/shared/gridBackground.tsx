export function GridBackground() {
  return (
    <div className="bg-gradient-surface absolute inset-0 h-full w-full overflow-hidden">
      {/* Grid lines */}
      ...
      <div className="bg-background pointer-events-none absolute inset-0 mask-[radial-gradient(ellipse_at_center,transparent_10%,black)]" />
    </div>
  );
}
